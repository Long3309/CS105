...
})({"37Vcl":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a87a7489734fbaf1";
"use strict";
...
},{}],"b2ISM":[function(require,module,exports) {
...
var _cannonEsJs = require("../cannonjs/cannon-es.js");
var _cannonEsDebuggerJs = require("../cannonjs/cannon-es-debugger.js");
var _cannonEsDebuggerJsDefault = parcelHelpers.interopDefault(_cannonEsDebuggerJs);
...
async function init() {
    ...
    const ambient = new _three.HemisphereLight(0xffffbb, 0x080820);
    scene.add(ambient);
...
function initCannon() {
    // Setup world
    world = new _cannonEsJs.World();
    world.gravity.set(0, -9.8, 0);
    initCannonDebugger();
}
function initCannonDebugger() {
    cannonDebugger = new (0, _cannonEsDebuggerJsDefault.default)(scene, world, {
        onInit (body, mesh) {
            mesh.visible = false;
            // Toggle visibiliy on "d" press
            document.addEventListener("keydown", (event)=>{
                if (event.key === "f") mesh.visible = !mesh.visible;
            });
        }
    });
}
async function addBackground() {
    const gltfLoader = new (0, _gltfloaderJs.GLTFLoader)().setPath("assets/");
    const mountainLoaded = await gltfLoader.loadAsync("mountain.glb");
    let mountainMesh = mountainLoaded.scene.children[0];
    mountainMesh.quaternion.setFromAxisAngle(new _cannonEsJs.Vec3(0, 1, 0), -Math.PI / 180 * 90);
    ...
    domeMesh.quaternion.setFromAxisAngle(new _cannonEsJs.Vec3(0, 1, 0), -Math.PI / 180 * 90);
...
function movePlayer() {
    ...
    const forceForward = new _cannonEsJs.Vec3(0, 0, strengthWS);
    if (keyboard["W"]) cubeBody.applyLocalForce(forceForward);
    // down letter S
    const forceBack = new _cannonEsJs.Vec3(0, 0, -strengthWS);
    ...
    const forceLeft = new _cannonEsJs.Vec3(0, strengthAD, 0);
    if (keyboard["A"]) cubeBody.applyTorque(forceLeft);
    // right letter D
    const forceRigth = new _cannonEsJs.Vec3(0, -strengthAD, 0);
...
function addCubeBody() {
    let cubeShape = new _cannonEsJs.Box(new _cannonEsJs.Vec3(1, 1.3, 2));
    slipperyMaterial = new _cannonEsJs.Material("slippery");
    cubeBody = new _cannonEsJs.Body({
        mass: 100,
        material: slipperyMaterial
    });
    cubeBody.addShape(cubeShape, new _cannonEsJs.Vec3(0, 0, -1));
    const polyhedronShape = createCustomShape();
    cubeBody.addShape(polyhedronShape, new _cannonEsJs.Vec3(-1, -1.3, 1));
    // change rotation
    cubeBody.quaternion.setFromAxisAngle(new _cannonEsJs.Vec3(0, 1, 0), Math.PI / 180 * 180);
...
function createCustomShape() {
    const vertices = [
        new _cannonEsJs.Vec3(2, 0, 0),
        new _cannonEsJs.Vec3(2, 0, 2),
        new _cannonEsJs.Vec3(2, 2, 0),
        new _cannonEsJs.Vec3(0, 0, 0),
        new _cannonEsJs.Vec3(0, 0, 2),
        new _cannonEsJs.Vec3(0, 2, 0)
    ];
    return new _cannonEsJs.ConvexPolyhedron({
        vertices,
        faces: [
            [
                3,
...
function addPlaneBody() {
    groundMaterial = new _cannonEsJs.Material("ground");
    const planeShape = new _cannonEsJs.Box(new _cannonEsJs.Vec3(10, 0.01, 100));
    planeBody = new _cannonEsJs.Body({
        mass: 0,
...
function addPlane() {
    const texture = new _three.TextureLoader().load("assets/plane.png");
    let geometry = new _three.BoxGeometry(20, 0, 200);
    let material = new _three.MeshBasicMaterial({
        map: texture
    });
    let planeThree = new _three.Mesh(geometry, material);
    planeThree.position.set(0, 0, -90);
    scene.add(planeThree);
}
function addObstacleBody() {
    for(let i = 0; i < 5; i++){
        let obstacleShape = new _cannonEsJs.Box(new _cannonEsJs.Vec3(1, 1, 1));
        obstacleBody = new _cannonEsJs.Body({
            mass: 1
        });
...
function addObstacle() {
    let geometry = new _three.BoxGeometry(2, 2, 2);
    const texture = new _three.TextureLoader().load("assets/obstacle.png");
    let material = new _three.MeshBasicMaterial({
        map: texture
    });
    let obstacle = new _three.Mesh(geometry, material);
    for(let i = 0; i < 5; i++){
...
function addContactMaterials() {
    const slippery_ground = new _cannonEsJs.ContactMaterial(groundMaterial, slipperyMaterial, {
        friction: 0.00,
        restitution: 0.1,
...
function addGUI() {
    gui = new (0, _lilGuiModuleMinJsDefault.default)();
    const options = {
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","three/examples/jsm/loaders/GLTFLoader.js":"dVRsF","three/examples/jsm/libs/lil-gui.module.min.js":"dUXFx","../cannonjs/cannon-es.js":"cChqj","../cannonjs/cannon-es-debugger.js":"6WhpM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dUXFx":[function(require,module,exports) {
/**
 * lil-gui
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cChqj":[function(require,module,exports) {
/**
   ...
   */ getVehicleAxisWorld(axisIndex, result) {
    ...
    updateVehicle(timeStep) {
        ...
        for(let i = 0; i < numWheels; i++){
            ...
            if ((wheel.sliding || !wheel.isInContact) && wheel.engineForce !== 0 && wheel.useCustomSlidingRotationalSpeed) // Apply custom rotation when accelerating and sliding
   ...
   */ getContacts(p1, p2, world, result, oldcontacts, frictionResult, frictionPool) {
    ...
    sphereBox(si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
        ...
        for(let j = 0; j !== Nsides && !found; j++){
            for(let k = 0; k !== Nsides && !found; k++)if (j % 3 !== k % 3) {
                // Get edge tangent
    ...
    internalStep(dt) {
        ...
        for(let k = 0; k !== ncontacts; k++){
            ...
            if (bi.allowSleep && bi.type === Body.DYNAMIC && bi.sleepState === Body.SLEEPING && bj.sleepState === Body.AWAKE && bj.type !== Body.STATIC) {
                ...
                if (speedSquaredB >= speedLimitSquaredB * 2) bi.wakeUpAfterNarrowphase = true;
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6WhpM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"cannon-es":"HCu3b","three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"HCu3b":[function(require,module,exports) {
/**
 * Records what objects are colliding with each other
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["37Vcl","b2ISM"], "b2ISM", "parcelRequire94c2")

//# sourceMappingURL=main.734fbaf1.js.map
